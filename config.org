...
(defun my:restart-anaconda ()
  "hacky way of restart anaconda process"
  (interactive)
...
(defun my:python-init ()
  ...
  ;; (local-set-key (kbd "C-c C-r") 'my:restart-anaconda)
...
(use-package rainbow-delimiters
  ...
  :ensure t)
(add-hook 'inferior-emacs-lisp-mode-hook 'turn-off-smartparens-mode)
