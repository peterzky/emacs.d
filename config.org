...
(defvar peter/emacs-state-modes
  '(artist-mode dired-mode ivy-occur-mode view-mode debugger-mode interactive-haskell-mode))
...
#+BEGIN_SRC sh
stack --nix install ghc-mod structured-haskell-mode happy hindent
#+END_SRC
