...
(setq org-agenda-text-search-extra-files '("~/Sync/sync/org/agenda/archive.org"))
...
(defun xmobar-format (time-color task-color)
   ...
   (concat "[" (xmobar-color time-color time) "] " (xmobar-color task-color task))))
#+END_SRC
** Org Caputre
#+BEGIN_SRC emacs-lisp
