...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(bold ((t (:foreground "red" :slant normal :weight bold :height 128 :width normal :foundry "MS  " :family "Consolas"))))
