 ...
 '(org-publish-project-alist
   (\`
    (("default" :base-directory
     ...
     ("web" :components
      ("images" "js" "css")))))
 '(org2jekyll-blog-author "Peterzky" nil (org2jekyll))
 '(org2jekyll-jekyll-directory (expand-file-name "~/Projects/Blog/") nil (org2jekyll))
