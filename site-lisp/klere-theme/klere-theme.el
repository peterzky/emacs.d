 ...
 (let ((class   '((class color) (min-colors 89)))
   ...
   'klere
	...
	`(org-hide                                 ((,class (:foreground ,fg4))))
        ...
        `(org-level-2                              ((,class (:bold t :foreground ,fg3 :height 1.1))))
        `(org-level-3                              ((,class (:bold t :foreground ,fg4 :height 1.1))))
        `(org-level-4                              ((,class (:bold t :foreground ,bg5 :height 1.1))))
        ...
        `(org-done                                 ((,class (:bold t :foreground ,bg5))))
        `(org-warning                              ((,class (:underline t :foreground ,warning))))
        `(org-agenda-structure                     ((,class (:foreground ,fg3 :background ,bg4))))
        `(org-agenda-date                          ((,class (:foreground ,var ))))
        `(org-agenda-date-weekend                  ((,class (:foreground ,fg4))))
        `(org-agenda-date-today                    ((,class (:foreground ,keyword))))
