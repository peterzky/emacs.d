...
(defconst doom-themes-common-faces
  '(;; --- custom faces -----------------------
    ...
    (tooltip              :inherit 'doom-default :background (doom-lighten bg 0.1) :foreground (doom-lighten fg 0.3))
    ...
    ;; org-mode
    (org-level-1 :foreground blue :background bg :bold bold :height 1.1)
    ...
    (org-block-begin-line      :foreground comments :background bg)
...
(defun doom-themes--build-face (face)
  ...
  `(list
    ...
    ,(cond ((keywordp (cadr face))
           ...
           ((memq (car-safe (cadr face)) '(quote backquote \`))
            (cadr face))
